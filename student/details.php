                                                        ...
                                                        <div class="row clearfix">
                                                            <div class="col-sm-12 col-md-6">
                                                                <div class="form-group">
                                                                    <div class="form-line">
                                                                        <label class="required" for="father's_name">Father's Name</label>
                                                            ...
                                                            <div class="col-sm-12 col-md-6">
                                                                <div class="form-group">
                                                                    <div class="form-line">
                                                                        <label class="required" class="required" for="mother's_name">Mother's Name</label>
                                                        ...
                                                        <div class="row clearfix">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="fallback">
                                                                        <input id="photo" name="file" type="file" required/>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <form method="POST" action="#">
                                                        ...
                                                        <div class="row clearfix">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <div class="form-line">
                                                                        <label class="required" for="guardian_address">Guardian's Address</label>
                                                        ...
                                                        <div class="row clearfix">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <div class="form-line">
                                                                        <label class="required" for="alt_g_contact">Guardian's Contact (Alternate)</label>
