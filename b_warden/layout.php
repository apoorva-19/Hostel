                        ...
                        <div class="row clearfix">
                            <div class="body">
                                <div class="demo-button-toolbar clearfix">
                                            ...
                                            <td style="padding-left:0px; padding-right:0px;">                                        
                                                <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                                    <div class="btn-group" role="group" aria-label="First group">
                                                        <button id="101A" onclick="setText(this.value);" value="101A" type="button" class="seating-btn seating-btn seating-btn btn btn-default btn-xs waves-effect">101A</button>
                                                        <button id="102A" onclick="setText(this.value);" value="102A" type="button" class="seating-btn btn btn-default btn-xs waves-effect">102A</button>
                                                        <button id="103A" onclick="setText(this.value);" value="103A" type="button" class="seating-btn btn btn-default btn-xs waves-effect">103A</button>
                                                        <button id="104A" onclick="setText(this.value);" value="104A" type="button" class="seating-btn btn btn-default btn-xs waves-effect">104A</button>
                                                        <button id="105A" onclick="setText(this.value);" value="105A" type="button" class="seating-btn btn btn-default btn-xs waves-effect">105A</button>
                                                        <button id="106A" onclick="setText(this.value);" value="106A" type="button" class="seating-btn btn btn-default btn-xs waves-effect">106A</button>
                                                        <button id="107A" onclick="setText(this.value);" value="107A" type="button" class="seating-btn btn btn-default btn-xs waves-effect">107A</button>
                                                        <button id="108A" onclick="setText(this.value);" value="108A" type="button" class="seating-btn btn btn-default btn-xs waves-effect">108A</button>
                                                        <button id="109A" onclick="setText(this.value);" value="109A" type="button" class="seating-btn btn btn-default btn-xs waves-effect">109A</button>
                                                        <button id="110A" onclick="setText(this.value);" value="110A" type="button" class="seating-btn btn btn-default btn-xs waves-effect">110A</button>
                                                        <button id="111A" onclick="setText(this.value);" value="111A" type="button" class="seating-btn btn btn-default btn-xs waves-effect">111A</button>
                                                        <button id="112A" onclick="setText(this.value);" value="112A" type="button" class="seating-btn btn btn-default btn-xs waves-effect">112A</button>
                                                        <button id="113A" onclick="setText(this.value);" value="113A" type="button" class="seating-btn btn btn-default btn-xs waves-effect">113A</button>
                                                        <button id="114A" onclick="setText(this.value);" value="114A" type="button" class="seating-btn btn btn-default btn-xs waves-effect">114A</button>
                                                        <button id="115A" onclick="setText(this.value);" value="115A" type="button" class="seating-btn btn btn-default btn-xs waves-effect">115A</button>
                                                        <button id="116A" onclick="setText(this.value);" value="116A" type="button" class="seating-btn btn btn-default btn-xs waves-effect">116A</button>
                                                        <button id="117A" onclick="setText(this.value);" value="117A" type="button" class="seating-btn btn btn-default btn-xs waves-effect">117A</button>
                                                    </div>
                                                </div>
                                                <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                                    <div class="btn-group" role="group" aria-label="First group">
                                                        <button id="101B" onclick="setText(this.value);" value="101B" type="button" class="seating-btn btn btn-default btn-xs waves-effect">101B</button>
                                                        <button id="102B" onclick="setText(this.value);" value="102B" type="button" class="seating-btn btn btn-default btn-xs waves-effect">102B</button>
                                                        <button id="103B" onclick="setText(this.value);" value="103B" type="button" class="seating-btn btn btn-default btn-xs waves-effect">103B</button>
                                                        <button id="104B" onclick="setText(this.value);" value="104B" type="button" class="seating-btn btn btn-default btn-xs waves-effect">104B</button>
                                                        <button id="105B" onclick="setText(this.value);" value="105B" type="button" class="seating-btn btn btn-default btn-xs waves-effect">105B</button>
                                                        <button id="106B" onclick="setText(this.value);" value="106B" type="button" class="seating-btn btn btn-default btn-xs waves-effect">106B</button>
                                            ...
                                            <td style="padding-left:0px; padding-right:0px;">                                        
                                                <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                                    <div class="btn-group" role="group" aria-label="First group">
                                                        ...
                                                        <button id="411A" onclick="setText(this.value);" value="411A" type="button" class="seating-btn btn btn-default btn-xs waves-effect">411A</button>
                                                        <button id="412A" onclick="setText(this.value);" value="412A" type="button" class="seating-btn btn btn-default btn-xs waves-effect">412A</button>
                                                        <button id="413A" onclick="setText(this.value);" value="413A" type="button" class="seating-btn btn btn-default btn-xs waves-effect">413A</button>
                                                        <button id="414A" onclick="setText(this.value);" value="414A" type="button" class="seating-btn btn btn-default btn-xs waves-effect">414A</button>
                                                        <button id="415A" onclick="setText(this.value);" value="415A" type="button" class="seating-btn btn btn-default btn-xs waves-effect">415A</button>
                                                        <button id="416A" onclick="setText(this.value);" value="416A" type="button" class="seating-btn btn btn-default btn-xs waves-effect">416A</button>
                                                        <button id="417A" onclick="setText(this.value);" value="417A" type="button" class="seating-btn btn btn-default btn-xs waves-effect">417A</button>
                                                    </div>
                                                </div>
                                                <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                                    <div class="btn-group" role="group" aria-label="First group">
                                                        ...
                                                        <button id="411B" onclick="setText(this.value);" value="411B" type="button" class="seating-btn btn btn-default btn-xs waves-effect">411B</button>
                                                        <button id="412B" onclick="setText(this.value);" value="412B" type="button" class="seating-btn btn btn-default btn-xs waves-effect">412B</button>
                                                        <button id="413B" onclick="setText(this.value);" value="413B" type="button" class="seating-btn btn btn-default btn-xs waves-effect">413B</button>
                                                        <button id="414B" onclick="setText(this.value);" value="414B" type="button" class="seating-btn btn btn-default btn-xs waves-effect">414B</button>
                                                        <button id="415B" onclick="setText(this.value);" value="415B" type="button" class="seating-btn btn btn-default btn-xs waves-effect">415B</button>
                                                        <button id="416B" onclick="setText(this.value);" value="416B" type="button" class="seating-btn btn btn-default btn-xs waves-effect">416B</button>
                                                        <button id="417B" onclick="setText(this.value);" value="417B" type="button" class="seating-btn btn btn-default btn-xs waves-effect">417B</button>
                                                    </div>    
                                                </div>
                                            </td>
                                        </tr>
                                    ...
                                    <button type='submit' class="btn btn-primary mt-5 waves-effect" style="float:right;">Submit</button>
                                </div>
                            </div>
                        </div>
                    </div>
