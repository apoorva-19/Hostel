    ...
    <script>
        function successRange(resultJson)
        {
            ...
            else 
            {
                ...
                {
                    $('#g_table').append("<tr><th></th><td></td><td></td><td>No entries found.</td><td></td><td></td></tr>");
                }
                ...
                {
                    $('#b_table').append("<tr><th></th><td></td><td></td><td>No entries found.</td><td></td><td></td></tr>");
                }
            }
        ...
        function submitDate()
        {
            ...
            httpPostAsync('data_food.php', postData, successRange);
        }
    </script>
</body>
</html>